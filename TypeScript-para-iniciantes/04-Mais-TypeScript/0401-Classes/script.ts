...
class Produto {
  readonly tipo = "produto"; // não é possível alterar o valor
  public nome: string; // padrão
  private preco: number; // acesso somente à esta classe
  protected preco2?: number; // acesso à esta classe e subClasses
...
class Livro extends Produto {} // não herda preco
